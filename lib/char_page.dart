...
import 'package:ricknmorty/char_provider.dart';
import 'package:ricknmorty/char_repository.dart';

class CharPage extends StatefulHookConsumerWidget {
  const CharPage({Key? key}) : super(key: key);

  @override
  ConsumerState<CharPage> createState() => _CharPageState();
}
...
class _CharPageState extends ConsumerState<CharPage> {
  ...
  Widget build(BuildContext context) {
    final characters = ref.watch(charProvider);
    return Scaffold(
      ...
      body: Visibility(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              CharModel myChar = characters[index];
              return Column(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: Color.fromARGB(255, Random().nextInt(1000),
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                Row(
                                  children: [
                                    Text('genero : ${myChar.gender}'),
                                  ],
                                ),
                                Text('especie : ${myChar.species}'),
                                Text('planet origin : ${myChar.originPlanet}'),
